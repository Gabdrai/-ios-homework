 ...
 */
let heartRade1D = Double(heartRate1)
let heartRade2D = Double(heartRate2)
let heartRade3D = Double(heartRate3)
let addedHRD =  heartRade1D + heartRade2D + heartRade3D
