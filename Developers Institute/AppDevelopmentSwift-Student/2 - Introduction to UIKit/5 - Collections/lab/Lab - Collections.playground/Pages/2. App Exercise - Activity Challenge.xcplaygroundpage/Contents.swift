 ...
 */
var walkingChallenges: [String] = ["Walk 3 miles a day", "Walk up the stairs 3 times a day"]
var runningChallenges: [String] = ["Run 5 times a week", "Run 50 miles a month"]
...
if committedChallenges.isEmpty {
    print("Try to commit to a challenge today")
}
